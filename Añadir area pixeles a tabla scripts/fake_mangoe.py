...
for row in rows:
    ...
    _frame,area_total,area_spot = fake_util.get_area( mangoe_name )
    ...
    new_weight = weight + Decimal('0.07')*weight
    root_path = "fake/"  
    save_path = os.path.join(root_path, 'mangoe_'+str(id)+'_peso_'+str(new_weight)+'.jpg')
