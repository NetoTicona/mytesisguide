...
df = pd.DataFrame({ "Reales" :  pivote }) 
#df["weights"] = weights
df["Estimados"] = output_Est
print(df)

dataset["Estimados"] = output_Est
dataset.to_excel('generated_data_with_estimated_values.xlsx', index=False)
